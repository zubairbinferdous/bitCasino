    ...
    return (
        ...
        <div className="container-fluid bg-g">
               <div className="container text-area">
                <h5 className='text-white'>Fishin' Bear Free Play</h5>
                <h3 className="text-white mb-5">
                Fishin' Bear Slot Demo</h3>  
               ...
               <div className="col-md-8">
                ...
                <br />
                   ...
                   <h3 className="section-title mt-5">Fishin' Bear Slot Review</h3>
                   ...
                   <div className="row">
                    ...
                    <div className="section-container custom-bg bgggOne " >
                              ...
                              <p>
                              Fishin' Bear slot is another promising addition to the list of Big Bass slots by Pragmatic Play. The fisherman has now hopped into his monster truck, and he is ready to catch even more fish. This slot will remind you of Big Bass Bonanza, as it also has a 5x3 layout with 10 paylines. The Free Spins is the most important feature, and it allows you to win up to 5,000x of your stake.

In this Fishin' Bear review, you will see what makes this slot special. You will clear all of your doubts if you read till the end.<br /><br />
                              </p>
                ...
                <div className="card shadow-sm" >
                    <div className="card-body">
                        ...
                        <ul className="list-unstyled mb-0">
                            ...
                            <li className="d-flex align-items-start mb-2">
                                <span className="text-success me-2 fw-bold">+</span>
                                <span>Unique features like Wild Rewind</span>
                            </li>
                            <li className="d-flex align-items-start mb-2">
                                <span className="text-success me-2 fw-bold">+</span>
                                <span>High RTP of 96.50%</span>
                            </li>
                            <li className="d-flex align-items-start mb-2">
                                <span className="text-success me-2 fw-bold">+</span>
                                <span>Sticky Fish in the Free Spins</span>
                            </li>
                            <li className="d-flex align-items-start">
                                <span className="text-success me-2 fw-bold">+</span>
                                <span>Buy Bonus feature</span>
                            </li>
                        </ul>
                    </div>
            ...
            <div className="row">
                ...
                <div className="col-6 text-end fw-bold text-danger">3 Oaks</div>
                ...
                <div className="col-6 text-end fw-bold">96.67</div>
            ...
            <div className="row">
                ...
                <div className="col-6 text-end fw-bold">75.00</div>
                ...
                <div className="col-6 text-end fw-bold">25</div>
            </div>
                    </div>
                    </div>
