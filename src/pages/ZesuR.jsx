               ...
               <div className="col-md-8">
                ...
                <br />
                   ...
                   <div className="row">
                    ...
                    <img src={cReview2} alt="" className='img-fluid'/>
                    </div>
...
In this Big Bass Splash review, you will see what makes this slot special. You will clear all of your doubts if you read till the end.<br /><br />
                    ...
                    <div className="card-body">
                        ...
                        <ul className="list-unstyled mb-0">
                            <li className="d-flex align-items-start mb-2">
                                ...
                                <span>Enjoy up to 50 Free Spins</span>
                            </li>
                            <li className="d-flex align-items-start mb-2">
                                <span className="text-success me-2 fw-bold">+</span>
                                <span>High RTP of 96.78%</span>
                            </li>
                            <li className="d-flex align-items-start mb-2">
                                <span className="text-success me-2 fw-bold">+</span>
                                <span>Thrilling Money Respin feature</span>
                            </li>
                            <li className="d-flex align-items-start mb-2">
                                <span className="text-success me-2 fw-bold">+</span>
                                <span>Bonus Buy option available</span>
                            </li>
                            <li className="d-flex align-items-start">
                                <span className="text-success me-2 fw-bold">+</span>
                                <span>Simple gameplay</span>
                            </li>
                        </ul>
                    </div>
            ...
            <div className="row">
                ...
                <div className="col-6 text-end fw-bold text-danger">Habanero</div>
                ...
                <div className="col-6 text-end fw-bold">95.78</div>
            ...
            <div className="row">
                ...
                <div className="col-6 text-end fw-bold">125.00</div>
                ...
                <div className="col-6 text-end fw-bold">4</div>
                ...
                <div className="features card p-3">
                    ...
                    <div className="">
                    <span className="feature-tag">Ancient civilizations</span>
